...
) ENGINE=InnoDB AUTO_INCREMENT=11344251 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `member` VALUES (11344250,'傻逼','123@gmail.com','123','0965xxx','傻逼中心');
...
CREATE TABLE `orders` (
  ...
  `Status` enum('未付款','已出貨','完成') DEFAULT NULL,
  PRIMARY KEY (`OrderID`),
...
CREATE TABLE `product` (
  `ProductID` int NOT NULL,
  `ProductName` varchar(45) NOT NULL DEFAULT 'null',
...
-- Dump completed on 2026-06-02 18:22:23
